...
function CoreWeb_scripts() {
	...
	wp_register_style('Core-style-add', get_template_directory_uri() . '/css/index.css' );
	$dependencies = array('Core-style-add');
	wp_enqueue_style( 'Core-style-add', get_stylesheet_uri() );

	wp_register_style('Core-style-grid', get_template_directory_uri() . '/css/grid.css' );
	$dependencies = array('Core-style-grid');
	wp_enqueue_style( 'Core-style-grid', get_stylesheet_uri() );
	
	
	wp_register_style('Core-style-icono', get_template_directory_uri() . '/css/style-icono.css' );
	$dependencies = array('Core-style-icono');
	wp_enqueue_style( 'Core-style-icono', get_stylesheet_uri() );



	// wp_enqueue_script( 'CoreWeb-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20160816', true );
	...
	// if ( is_singular() && wp_attachment_is_image() ) {
		// wp_enqueue_script( 'CoreWeb-keyboard-image-navigation', get_template_directory_uri() . '/js/keyboard-image-navigation.js', array( 'jquery' ), '20160816' );
	// }

	// wp_enqueue_script( 'CoreWeb-script', get_template_directory_uri() . '/js/functions.js', array( 'jquery' ), '20160816', true );

	// wp_localize_script( 'CoreWeb-script', 'screenReaderText', array(
		// 'expand'   => __( 'expand child menu', 'CoreWeb' ),
		// 'collapse' => __( 'collapse child menu', 'CoreWeb' ),
	// ) );
}
